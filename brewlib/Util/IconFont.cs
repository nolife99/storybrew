...
{
    TenK = 0xe951,
    TenMegaPixels = 0xe952,
    ElevenMegaPixels = 0xe953,
    OneTwoThree = 0xeb8d,
    TwelveMegaPixels = 0xe954,
    ThirteenMegaPixels = 0xe955,
    FourteenMegaPixels = 0xe956,
    FifteenMegaPixels = 0xe957,
    SixteenMegaPixels = 0xe958,
    SeventeenMegaPixels = 0xe959,
    EighteenUpRating = 0xf8fd,
    EighteenMegaPixels = 0xe95a,
    NineteenMegaPixels = 0xe95b,
    OneK = 0xe95c,
    OneKPlus = 0xe95d,
    OneXMobiledata = 0xefcd,
    TwentyMegaPixels = 0xe95e,
    TwentyOneMegaPixels = 0xe95f,
    TwentyTwoMegaPixels = 0xe960,
    TwentyThreeMegaPixels = 0xe961,
    TwentyFourMegaPixels = 0xe962,
    TwoK = 0xe963,
    TwoKPlus = 0xe964,
    TwoMegaPixels = 0xe965,
    ThirtyFps = 0xefce,
    ...
    ThreeK = 0xe966,
    ThreeKPlus = 0xe967,
    ThreeMegaPixels = 0xe968,
    ThirdPerson = 0xefd1,
    FourGMobiledata = 0xefd2,
    FourGPlusMobiledata = 0xefd3,
    FourK = 0xe072,
    FourKPlus = 0xe969,
    FourMegaPixels = 0xe96a,
    FiveG = 0xef38,
    FiveK = 0xe96b,
    FiveKPlus = 0xe96c,
    FiveMegaPixels = 0xe96d,
    SixtyFps = 0xefd4,
    SixtyFpsSelect = 0xefd5,
    SixFtApart = 0xf21e,
    SixK = 0xe96e,
    SixKPlus = 0xe96f,
    SixMegaPixels = 0xe970,
    SevenK = 0xe971,
    SevenKPlus = 0xe972,
    SevenMegaPixels = 0xe973,
    EightK = 0xe974,
    EightKPlus = 0xe975,
    EightMegaPixels = 0xe976,
    NineK = 0xe977,
    NineKPlus = 0xe978,
    NineMegaPixels = 0xe979,
    Abc = 0xeb94,
    AcUnit = 0xeb3b,
    AccessAlarm = 0xe190,
    AccessAlarms = 0xe191,
