...
public static partial class Native
{
    ...
    public static unsafe void CopyMemory(nint source, nint destination, int count) => Unsafe.CopyBlockUnaligned(destination.ToPointer(), source.ToPointer(), unchecked((uint)count));
