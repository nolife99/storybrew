...
public class VertexAttribute
{
    ...
    public override bool Equals(object obj)
    {
        ...
        if (obj is not VertexAttribute otherAttribute ||
    ...
    public static VertexAttribute CreateColor(bool packed) => packed ? new()
    {
    ...
    public static VertexAttribute CreateVec4(string name, bool packed, AttributeUsage usage) => packed ? new()
    {
        Name = name,
        ComponentCount = 4,
        ComponentSize = 1,
