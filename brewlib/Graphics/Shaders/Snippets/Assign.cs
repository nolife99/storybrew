...
{
    public Assign(ShaderVariable result, ShaderVariable value, string components = null) : this(result, value.Ref.ToString,
        components) { }

    public Assign(ShaderVariable result, VertexAttribute value, string components = null) : this(result, () => value.Name,
        components) { }
