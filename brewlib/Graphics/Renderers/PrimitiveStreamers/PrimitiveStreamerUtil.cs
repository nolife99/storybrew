...
{
    public static PrimitiveStreamer DefaultCreatePrimitiveStreamer(VertexDeclaration vertDec, int minVert, ReadOnlySpan<ushort> indices)
    {
        ...
        if (PrimitiveStreamerVbo<TPrimitive>.HasCapabilities()) return new PrimitiveStreamerVbo<TPrimitive>(vertDec, indices);
