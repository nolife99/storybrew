    ...
    public class FlowLayout : Widget
    {
        ...
        protected override void DrawBackground(DrawContext drawContext, float actualOpacity)
        {
            ...
            foreach (var line in lines)
            {
                ...
                Manager.Skin.GetDrawable("debug")?.Draw(drawContext, Manager.Camera, new Box2(topLeft, bottomRight), actualOpacity * .5f);
        ...
        void measureChildren()
        {
            ...
            lines = new List<LayoutLine>();
            {
                ...
                foreach (var child in Children)
                {
                    ...
                    if (line == null || (flowWidth != 0
                        && innerSizeWidth < line.GetTotalWidth(spacing) + itemWidth + (line.Items.Count > 0 ? lineSpacing : 0)))
