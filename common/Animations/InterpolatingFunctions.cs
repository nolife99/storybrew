...
public static class InterpolatingFunctions
{
    ...
    public static readonly Func<float, float, float, float> Float = (from, to, progress)
    ...
    public static readonly Func<double, double, float, double> Double = (from, to, progress)
        => from + (to - from) * progress;
    ...
    public static readonly Func<CommandPosition, CommandPosition, float, CommandPosition> Position =
        (from, to, progress) => Vector2(from, to, progress);
    ...
    public static readonly Func<CommandColor, CommandColor, float, CommandColor> CommandColor =
