...
public static class EasingFunctions
{
    ...
    public static float ToInOut(Func<float, float> func, float value) => (value < .5f ? func(2 * value) : (2 - func(2 - 2 * value))) * .5f;
    ...
    public static readonly Func<float, float> BackInOut = x => ToInOut(y => y * y * ((1.70158f * 1.525f + 1) * y - 1.70158f * 1.525f), x);
    ...
    public static readonly Func<float, float> BounceOut = x => x < 1 / 2.75f ?
        7.5625f * x * x : x < 2 / 2.75f ?
        7.5625f * (x -= 1.5f / 2.75f) * x + .75f : x < 2.5f / 2.75f ?
        7.5625f * (x -= 2.25f / 2.75f) * x + .9375f : 7.5625f * (x -= 2.625f / 2.75f) * x + .984375f;
    ...
    public static readonly Func<float, float> ElasticOut = x => MathF.Pow(2, -10 * x) * MathF.Sin((x - .075f) * MathF.Tau / .3f) + 1;
    ///<summary/>
    public static readonly Func<float, float> ElasticOutHalf = x => MathF.Pow(2, -10 * x) * MathF.Sin((.5f * x - .075f) * MathF.Tau / .3f) + 1;
    ///<summary/>
    public static readonly Func<float, float> ElasticOutQuarter = x => MathF.Pow(2, -10 * x) * MathF.Sin((.25f * x - .075f) * MathF.Tau / .3f) + 1;
