...
public readonly record struct Keyframe<TValue> : IComparer<Keyframe<TValue>>
{
    ...
    /// <summary>Gets the value of the keyframe.</summary>
    public readonly TValue Value;

    /// <summary>Creates a new <see cref="Keyframe{TValue}"/> with the given time and optional value and easing function.</summary>
    ...
    /// <summary>
    ///     Creates a new <see cref="Keyframe{TValue}"/> with the same time and easing function as this one, but with the given
    ///     <paramref name="value"/>.
    /// </summary>
