...
public class MoveCommand(
    OsbEasing easing, float startTime, float endTime, CommandPosition startValue, CommandPosition endValue)
    : Command<CommandPosition>("M", easing, startTime, endTime, startValue, endValue)
{
    ...
    public override CommandPosition GetTransformedEndValue(StoryboardTransform transform)
