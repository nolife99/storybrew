...
public abstract class ObjectSerializer
{
    ...
    [
        ...
        new SimpleObjectSerializer<bool>(r => r.ReadBoolean(), (w, v) => w.Write(Unsafe.Unbox<bool>(v)),
            v => bool.Parse(v), v => Unsafe.Unbox<bool>(v).ToString()),
        ...
        new SimpleObjectSerializer<osuTK.Vector3>(
            r => new osuTK.Vector3(r.ReadSingle(), r.ReadSingle(), r.ReadSingle()), (w, v) =>
            {
        ...
        new SimpleObjectSerializer<Color4>(
            r => new Color4(r.ReadSingle(), r.ReadSingle(), r.ReadSingle(), r.ReadSingle()), (w, v) =>
            {
        ...
        }, v =>
        {
            var color = Unsafe.Unbox<Color4>(v);
            return color.R.ToString(CultureInfo.InvariantCulture) + "," +
                color.G.ToString(CultureInfo.InvariantCulture) + "," + color.B.ToString(CultureInfo.InvariantCulture) +
                "," + color.A.ToString(CultureInfo.InvariantCulture);
        })
    ];
...
public class SimpleObjectSerializer<T>(
    Func<BinaryReader, object> read, Action<BinaryWriter, object> write, Func<string, object> fromString = null,
