...
public class JsonFormat : Format<JsonTokenType>
{
    ...
    protected override Tokenizer<JsonTokenType> Tokenizer => new RegexTokenizer<JsonTokenType>(definitions, null);
    protected override TokenParser<JsonTokenType> TokenParser => new JsonTokenParser();
