...
using EA = Tiny.PooledCollections.ExceptionArgument;
using ER = Tiny.PooledCollections.ExceptionResource;
...
static class ThrowHelper
{
    ...
    static string GetArgumentName(EA argument)
    {
        switch (argument)
        {
            case EA.obj: return nameof(EA.obj);
            case EA.dictionary: return nameof(EA.dictionary);
            case EA.stack: return nameof(EA.stack);
            case EA.queue: return nameof(EA.queue);
            case EA.array: return nameof(EA.array);
            case EA.dest: return nameof(EA.dest);
            case EA.info: return nameof(EA.info);
            case EA.key: return nameof(EA.key);
            case EA.text: return nameof(EA.text);
            case EA.values: return nameof(EA.values);
            case EA.value: return nameof(EA.value);
            case EA.startIndex: return nameof(EA.startIndex);
            case EA.task: return nameof(EA.task);
            case EA.ch: return nameof(EA.ch);
            case EA.s: return nameof(EA.s);
            case EA.input: return nameof(EA.input);
            case EA.list: return nameof(EA.list);
            case EA.index: return nameof(EA.index);
            case EA.capacity: return nameof(EA.capacity);
            case EA.collection: return nameof(EA.collection);
            case EA.item: return nameof(EA.item);
            case EA.converter: return nameof(EA.converter);
            case EA.match: return nameof(EA.match);
            case EA.count: return nameof(EA.count);
            case EA.action: return nameof(EA.action);
            case EA.comparison: return nameof(EA.comparison);
            case EA.exceptions: return nameof(EA.exceptions);
            case EA.exception: return nameof(EA.exception);
            case EA.enumerable: return nameof(EA.enumerable);
            case EA.start: return nameof(EA.start);
            case EA.format: return nameof(EA.format);
            case EA.culture: return nameof(EA.culture);
            case EA.comparer: return nameof(EA.comparer);
            case EA.comparable: return nameof(EA.comparable);
            case EA.source: return nameof(EA.source);
            case EA.state: return nameof(EA.state);
            case EA.length: return nameof(EA.length);
            case EA.output: return nameof(EA.output);
            case EA.comparisonType: return nameof(EA.comparisonType);
            case EA.manager: return nameof(EA.manager);
            case EA.sourceBytesToCopy: return nameof(EA.sourceBytesToCopy);
            case EA.callBack: return nameof(EA.callBack);
            case EA.creationOptions: return nameof(EA.creationOptions);
            case EA.function: return nameof(EA.function);
            case EA.delay: return nameof(EA.delay);
            case EA.millisecondsDelay: return nameof(EA.millisecondsDelay);
            case EA.millisecondsTimeout: return nameof(EA.millisecondsTimeout);
            case EA.timeout: return nameof(EA.timeout);
            case EA.type: return nameof(EA.type);
            case EA.sourceIndex: return nameof(EA.sourceIndex);
            case EA.sourceArray: return nameof(EA.sourceArray);
            case EA.destinationIndex: return nameof(EA.destinationIndex);
            case EA.destinationArray: return nameof(EA.destinationArray);
            case EA.other: return nameof(EA.other);
            case EA.newSize: return nameof(EA.newSize);
            case EA.lowerBounds: return nameof(EA.lowerBounds);
            case EA.lengths: return nameof(EA.lengths);
            case EA.len: return nameof(EA.len);
            case EA.keys: return nameof(EA.keys);
            case EA.indices: return nameof(EA.indices);
            case EA.endIndex: return nameof(EA.endIndex);
            case EA.elementType: return nameof(EA.elementType);
            case EA.arrayIndex: return nameof(EA.arrayIndex);
            case EA.destIndex: return nameof(EA.destIndex);
    ...
    static string GetResourceString(ER resource)
    {
        switch (resource)
        {
            case ER.ArgumentOutOfRange_Index: return "Argument 'index' was out of the range of valid values.";
            ...
            case ER.ArgumentOutOfRange_NeedNonNegNum: return "The number must be non-negative.";
            case ER.ArgumentOutOfRange_SmallCapacity: return "The capacity cannot be set below the current Count.";
            case ER.Argument_InvalidOffLen: return "Invalid offset length.";

            case ER.ArgumentOutOfRange_BiggerThanCollection:
                return "The given value was larger than the size of the collection.";

            case ER.Serialization_MissingKeys: return "Serialization error: missing keys.";
            case ER.Serialization_NullKey: return "Serialization error: null key.";
            case ER.NotSupported_KeyCollectionSet: return "The KeyCollection does not support modification.";
            case ER.NotSupported_ValueCollectionSet: return "The ValueCollection does not support modification.";
            case ER.InvalidOperation_NullArray: return "Null arrays are not supported.";
            ...
            case ER.Argument_InvalidArgumentForComparison: return "Invalid argument for comparison.";
            ...
            case ER.Serialization_Pooled_NullKey: return "Serialized PooledDictionary had null key.";
            ...
            case ER.Queue_Empty: return "Queue is empty.";
            case ER.Collection_Modified: return "Collection was modified during enumeration.";
            case ER.Enumeration_NotStarted: return "Enumeration was not started.";
