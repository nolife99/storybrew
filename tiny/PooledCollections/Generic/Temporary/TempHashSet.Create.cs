...
partial struct TempHashSet<T>
{
    ...
    public static TempHashSet<T> Create() => new(0, null, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempHashSet<T> Create(int capacity)
        => new(capacity, null, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempHashSet<T> Create(IEnumerable<T> collection)
        => new(collection, null, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempHashSet<T> Create(IEqualityComparer<T>? comparer)
        => new(comparer, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempHashSet<T> Create(IEnumerable<T> collection, IEqualityComparer<T>? comparer)
        => new(collection, comparer, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempHashSet<T> Create(int capacity, IEqualityComparer<T>? comparer)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempHashSet<T> Create(T[] items) => new(items.AsSpan());

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempHashSet<T> Create(T[] items, IEqualityComparer<T>? comparer) => new(items.AsSpan(),
        comparer,
        ArrayPool<int>.Shared,
        ArrayPool<Entry<T>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempHashSet<T> Create(T[] items,
        IEqualityComparer<T>? comparer,
        ArrayPool<int> bucketPool,
        ArrayPool<Entry<T>> entryPool) => new(items.AsSpan(), comparer, bucketPool, entryPool);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempHashSet<T> Create(ReadOnlySpan<T> span) => new(span);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempHashSet<T> Create(ReadOnlySpan<T> span, IEqualityComparer<T>? comparer)
        => new(span, comparer, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempHashSet<T> Create(ReadOnlySpan<T> span,
        IEqualityComparer<T>? comparer,
        ArrayPool<int> bucketPool,
