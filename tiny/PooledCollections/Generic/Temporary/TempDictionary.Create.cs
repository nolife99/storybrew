...
partial struct TempDictionary<TKey, TValue>
{
    ...
    public static TempDictionary<TKey, TValue> Create()
        => new(0, null, ArrayPool<int>.Shared, ArrayPool<Entry<TKey, TValue>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempDictionary<TKey, TValue> Create(int capacity)
        => new(capacity, null, ArrayPool<int>.Shared, ArrayPool<Entry<TKey, TValue>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempDictionary<TKey, TValue> Create(IEqualityComparer<TKey>? comparer)
        => new(0, comparer, ArrayPool<int>.Shared, ArrayPool<Entry<TKey, TValue>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempDictionary<TKey, TValue> Create(IDictionary<TKey, TValue> dictionary) => new(dictionary,
        null,
        ArrayPool<int>.Shared,
        ArrayPool<Entry<TKey, TValue>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempDictionary<TKey, TValue> Create(IEnumerable<KeyValuePair<TKey, TValue>> collection)
        => new(collection, null, ArrayPool<int>.Shared, ArrayPool<Entry<TKey, TValue>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempDictionary<TKey, TValue> Create(int capacity, IEqualityComparer<TKey>? comparer) => new(capacity,
        comparer,
        ArrayPool<int>.Shared,
        ArrayPool<Entry<TKey, TValue>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempDictionary<TKey, TValue> Create(IDictionary<TKey, TValue> dictionary,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempDictionary<TKey, TValue> Create(ArrayPool<int> bucketPool, ArrayPool<Entry<TKey, TValue>> entryPool)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempDictionary<TKey, TValue> Create((TKey Key, TValue Value)[] array, IEqualityComparer<TKey>? comparer)
        => new(array.AsSpan(), comparer, ArrayPool<int>.Shared, ArrayPool<Entry<TKey, TValue>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempDictionary<TKey, TValue> Create((TKey Key, TValue Value)[] array,
        IEqualityComparer<TKey>? comparer,
        ArrayPool<int> bucketPool,
        ArrayPool<Entry<TKey, TValue>> entryPool) => new(array.AsSpan(), comparer, bucketPool, entryPool);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempDictionary<TKey, TValue> Create(KeyValuePair<TKey, TValue>[] array, IEqualityComparer<TKey>? comparer)
        => new(array.AsSpan(), comparer, ArrayPool<int>.Shared, ArrayPool<Entry<TKey, TValue>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TempDictionary<TKey, TValue> Create(KeyValuePair<TKey, TValue>[] array,
        IEqualityComparer<TKey>? comparer,
        ArrayPool<int> bucketPool,
        ArrayPool<Entry<TKey, TValue>> entryPool) => new(array.AsSpan(), comparer, bucketPool, entryPool);
