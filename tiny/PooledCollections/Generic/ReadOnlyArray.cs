...
public readonly struct ReadOnlyArray<T> : IReadOnlyList<T>
{
    ...
    internal ReadOnlyArray(T[] array) => _array = array ?? s_emptyArray;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ReadOnlyArray<T> Empty() => new(s_emptyArray);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void CopyTo(T[] dest, int destIndex) => CopyTo(0, dest, destIndex, Length);
