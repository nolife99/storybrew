...
public readonly struct ValueKVPairDictionary<TKey, TValue> : IEnumerable<KVPair<TKey, TValue>>
{
    ...
    public ValueKVPairDictionary(in ValueDictionary<TKey, TValue> dictionary) => _dictionary = dictionary;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    IEnumerator<KVPair<TKey, TValue>> IEnumerable<KVPair<TKey, TValue>>.GetEnumerator() => new Enumerator(_dictionary);
...
public static class ValueDictionaryExtensions
{
    ...
    public static ValueKVPairDictionary<TKey, TValue> ToValueKVPairDictionary<TKey, TValue>(
        in this ValueDictionary<TKey, TValue> dictionary) => new(dictionary);
}