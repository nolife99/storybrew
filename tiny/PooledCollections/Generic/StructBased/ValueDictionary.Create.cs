...
partial struct ValueDictionary<TKey, TValue>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueDictionary<TKey, TValue> Create(IDictionary<TKey, TValue> dictionary) => new(dictionary,
        null,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueDictionary<TKey, TValue> Create(int capacity, IEqualityComparer<TKey>? comparer) => new(capacity,
        comparer,
        ArrayPool<int>.Shared,
        ArrayPool<Entry<TKey, TValue>>.Shared);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueDictionary<TKey, TValue> Create((TKey Key, TValue Value)[] array,
        IEqualityComparer<TKey>? comparer,
        ArrayPool<int> bucketPool,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueDictionary<TKey, TValue> Create(KeyValuePair<TKey, TValue>[] array,
        IEqualityComparer<TKey>? comparer,
        ArrayPool<int> bucketPool,
        ArrayPool<Entry<TKey, TValue>> entryPool) => new(array.AsSpan(), comparer, bucketPool, entryPool);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueDictionary<TKey, TValue> Create(KVPair<TKey, TValue>[] array,
        IEqualityComparer<TKey>? comparer,
        ArrayPool<int> bucketPool,
        ArrayPool<Entry<TKey, TValue>> entryPool) => new(array.AsSpan(), comparer, bucketPool, entryPool);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueDictionary<TKey, TValue> Create(ReadOnlySpan<(TKey Key, TValue Value)> span,
        IEqualityComparer<TKey>? comparer,
        ArrayPool<int> bucketPool,
        ArrayPool<Entry<TKey, TValue>> entryPool) => new(span, comparer, bucketPool, entryPool);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueDictionary<TKey, TValue> Create(ReadOnlySpan<KeyValuePair<TKey, TValue>> span,
        IEqualityComparer<TKey>? comparer,
        ArrayPool<int> bucketPool,
        ArrayPool<Entry<TKey, TValue>> entryPool) => new(span, comparer, bucketPool, entryPool);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueDictionary<TKey, TValue> Create(ReadOnlySpan<KVPair<TKey, TValue>> span,
        IEqualityComparer<TKey>? comparer,
        ArrayPool<int> bucketPool,
        ArrayPool<Entry<TKey, TValue>> entryPool) => new(span, comparer, bucketPool, entryPool);
}