...
partial struct ValueHashSet<T>
{
    ...
    public static ValueHashSet<T> Create() => new(0, null, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueHashSet<T> Create(T[] items) => new(items.AsSpan(), null);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueHashSet<T> Create(T[] items, IEqualityComparer<T>? comparer) => new(items.AsSpan(),
        comparer,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueHashSet<T> Create(ReadOnlySpan<T> span) => new(span, null);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueHashSet<T> Create(ReadOnlySpan<T> span, IEqualityComparer<T>? comparer)
        => new(span, comparer, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueHashSet<T> Create(ReadOnlySpan<T> span,
        IEqualityComparer<T>? comparer,
        ArrayPool<int> bucketPool,
