...
public static class ValueHashSet
{
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueHashSet<T> Create<T>() => new(0, null, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueHashSet<T> Create<T>(IEnumerable<T> collection, IEqualityComparer<T> comparer)
        => new(collection, comparer, ArrayPool<int>.Shared, ArrayPool<Entry<T>>.Shared);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueHashSet<T> Create<T>(int capacity, IEqualityComparer<T> comparer)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ValueHashSet<T> Create<T>(ReadOnlySpan<T> span, IEqualityComparer<T> comparer)
