...
partial class ValueCollectionInternalsUnsafe
{
    ...
    public static ValueArrayDictionaryInternalsRefUnsafe<TKey, TValue> GetRef<TKey, TValue>(
        in ValueArrayDictionary<TKey, TValue> source) => new(source);

    /// <summary>Returns the internal Keys and Values arrays as a <see cref="Span{T}"/>.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void AsSpan<TKey, TValue>(in this ValueArrayDictionary<TKey, TValue> source,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Span<ArrayEntry<TKey>> KeysAsSpan<TKey, TValue>(in this ValueArrayDictionary<TKey, TValue> source)
        => source._entries.AsSpan(0, source.Count);

    /// <summary>Returns the internal Values array as a <see cref="Span{T}"/>.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Span<TValue> ValuesAsSpan<TKey, TValue>(in this ValueArrayDictionary<TKey, TValue> source)
        => source._values.AsSpan(0, source.Count);

    /// <summary>Returns the internal Keys and Values arrays as a <see cref="Memory{T}"/>.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void AsMemory<TKey, TValue>(in this ValueArrayDictionary<TKey, TValue> source,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Memory<ArrayEntry<TKey>> KeysAsMemory<TKey, TValue>(in this ValueArrayDictionary<TKey, TValue> source)
        => source._entries.AsMemory(0, source.Count);

    /// <summary>Returns the internal Values array as a <see cref="Memory{T}"/>.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Memory<TValue> ValuesAsMemory<TKey, TValue>(in this ValueArrayDictionary<TKey, TValue> source)
        => source._values.AsMemory(0, source.Count);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void GetUnsafe<TKey, TValue>(this in ValueArrayDictionary<TKey, TValue> source,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void GetUnsafeKeys<TKey, TValue>(this in ValueArrayDictionary<TKey, TValue> source,
        out ArrayEntry<TKey>[] keys,
        out int count)
    {
        keys = source._entries;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void GetUnsafeValues<TKey, TValue>(this in ValueArrayDictionary<TKey, TValue> source,
        out TValue[] values,
        out int count)
    {
        values = source._values;
