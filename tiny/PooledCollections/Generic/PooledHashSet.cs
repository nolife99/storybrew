    ...
    : ICollection<T>, ISet<T>, IReadOnlyCollection<T>, IReadOnlySet<T>, ISerializable, IDeserializationCallback
{
    ...
    /// <summary>Removes all elements from the <see cref="PooledHashSet{T}"/> object.</summary>
    public void Clear()
    {
        var count = _count;
        if (count > 0)
    ...
    /// <summary>Determines whether the <see cref="PooledHashSet{T}"/> contains the specified element.</summary>
    /// <param name="item">The element to locate in the <see cref="PooledHashSet{T}"/> object.</param>
    /// <returns>true if the <see cref="PooledHashSet{T}"/> object contains the specified element; otherwise, false.</returns>
    ...
    /// <returns>true if the element is added to the <see cref="PooledHashSet{T}"/> object; false if the element is already present.</returns>
    ...
    /// <summary>
    ///     Modifies the current <see cref="PooledHashSet{T}"/> object to contain all elements that are present in itself, the
    ...
    /// <summary>
    ///     Modifies the current <see cref="PooledHashSet{T}"/> object to contain only elements that are present in that object
    ...
    /// <summary>Removes all elements in the specified collection from the current <see cref="PooledHashSet{T}"/> object.</summary>
    /// <param name="other">The collection to compare to the current <see cref="PooledHashSet{T}"/> object.</param>
    ...
    /// <summary>
    ///     Modifies the current <see cref="PooledHashSet{T}"/> object to contain only elements that are present either in that
    ...
    /// <summary>Determines whether a <see cref="PooledHashSet{T}"/> object is a subset of the specified collection.</summary>
    /// <param name="other">The collection to compare to the current <see cref="PooledHashSet{T}"/> object.</param>
    ...
    public bool IsSubsetOf(IEnumerable<T> other)
    {
        ...
        if (Count == 0 || other == this) return true;
    ...
    /// <summary>Determines whether a <see cref="PooledHashSet{T}"/> object is a proper subset of the specified collection.</summary>
    /// <param name="other">The collection to compare to the current <see cref="PooledHashSet{T}"/> object.</param>
    ...
    /// <summary>Determines whether a <see cref="PooledHashSet{T}"/> object is a proper superset of the specified collection.</summary>
    /// <param name="other">The collection to compare to the current <see cref="PooledHashSet{T}"/> object.</param>
    ...
    public bool IsSupersetOf(IEnumerable<T> other)
    {
        ...
        if (other is ICollection<T> otherAsCollection)
        {
            ...
            if (other is PooledHashSet<T> otherAsSet &&
    ...
    /// <param name="other">The collection to compare to the current <see cref="PooledHashSet{T}"/> object.</param>
    /// <returns>
    ///     true if the <see cref="PooledHashSet{T}"/> object is a proper superset of <paramref name="other"/>; otherwise,
    ///     false.
    /// </returns>
    ...
    /// <summary>
    ///     Determines whether the current <see cref="PooledHashSet{T}"/> object and a specified collection share common
    ///     elements.
    /// </summary>
    /// <param name="other">The collection to compare to the current <see cref="PooledHashSet{T}"/> object.</param>
    /// <returns>
    ///     true if the <see cref="PooledHashSet{T}"/> object and <paramref name="other"/> share at least one common element;
    ///     otherwise, false.
    /// </returns>
    ...
    /// <summary>Determines whether a <see cref="PooledHashSet{T}"/> object and the specified collection contain the same elements.</summary>
    /// <param name="other">The collection to compare to the current <see cref="PooledHashSet{T}"/> object.</param>
    ...
    ///     <see cref="PooledHashSet{T}"/> collection.
    /// </summary>
    ...
    /// <summary>
    ///     Sets the capacity of a <see cref="PooledHashSet{T}"/> object to the actual number of elements it contains, rounded
    ...
    ///     <see cref="PooledHashSet{T}"/> object.
    /// </summary>
    public static IEqualityComparer<PooledHashSet<T>> CreateSetComparer() => new HashSetEqualityComparer<T>();
    ...
    ///     Contains
    /// </summary>
    internal void IntersectWithHashSetWithSameComparer(PooledHashSet<T> other)
    {
        var entries = _entries;
        for (var i = 0; i < _count; i++)
        {
