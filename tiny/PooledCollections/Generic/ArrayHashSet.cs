...
public sealed class ArrayHashSet<T> : IArrayHashSet<T>, IDisposable where T : notnull
{
    ...
    public ArrayHashSet() : this(0, ArrayPool<ArrayEntry<T>>.Shared, ArrayPool<int>.Shared) { }

    public ArrayHashSet(int capacity) : this(capacity, ArrayPool<ArrayEntry<T>>.Shared, ArrayPool<int>.Shared) { }

    public ArrayHashSet(int capacity, ArrayPool<ArrayEntry<T>> entryPool, ArrayPool<int> bucketPool)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void CopyTo(scoped Span<T> dest) => CopyTo(dest, 0, Count);
    ...
    public struct Enumerator : IEnumerator<T>
    {
        ...
        public Enumerator(ArrayHashSet<T> set)
        {
            _set = set;
            _index = -1;
            _count = set.Count;
